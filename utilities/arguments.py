...
def parse_detect_args():
    ...
    parser.add_argument("-img", type=str, default="./examples/dog.jpg", help="Image file to process")
    parser.add_argument("-output_img", type=str, default="./detections.png", help="Output image file")
    ...
    parser.add_argument("--no_show", action="store_true", help="Does not display the image with detections")
